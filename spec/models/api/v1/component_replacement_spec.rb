...
RSpec.describe Api::V1::ComponentReplacement, type: :model do
  ...
  describe "scopes" do
    ...
    describe ".by_component" do
      it "filters by component_type" do
        result = Api::V1::ComponentReplacement.by_component("chain")
      ...
      it "returns empty when no matches" do
        result = Api::V1::ComponentReplacement.by_component("nonexistent")
    ...
    describe ".recent" do
      it "orders by service performed_at desc" do
        result = Api::V1::ComponentReplacement.recent
